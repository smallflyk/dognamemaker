...
export const metadata: Metadata = {
  ...
  description: "Browse our collection of dog names sorted by popularity, gender, and style. Find trending, classic, and unique options for your canine companion with our easy filters.",
